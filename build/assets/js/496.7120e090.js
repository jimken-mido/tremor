...
var addRequirement = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((name, type) => {
...
var getRequirements = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => requirements, "getRequirements");
var setNewReqId = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((id) => {
  if (latestRequirement !== void 0) {
    latestRequirement.id = id;
  }
}, "setNewReqId");
var setNewReqText = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((text) => {
  if (latestRequirement !== void 0) {
    latestRequirement.text = text;
  }
}, "setNewReqText");
var setNewReqRisk = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((risk) => {
  if (latestRequirement !== void 0) {
    latestRequirement.risk = risk;
  }
}, "setNewReqRisk");
var setNewReqVerifyMethod = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((verifyMethod) => {
  if (latestRequirement !== void 0) {
    latestRequirement.verifyMethod = verifyMethod;
  }
}, "setNewReqVerifyMethod");
var addElement = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((name) => {
  if (!elements.has(name)) {
    ...
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .Rm.info("Added new requirement: ", name);
  }
  latestElement = {};
  return elements.get(name);
}, "addElement");
var getElements = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => elements, "getElements");
var setNewElementType = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((type) => {
  if (latestElement !== void 0) {
    latestElement.type = type;
  }
}, "setNewElementType");
var setNewElementDocRef = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((docRef) => {
  if (latestElement !== void 0) {
    latestElement.docRef = docRef;
  }
}, "setNewElementDocRef");
var addRelationship = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((type, src, dst) => {
  relations.push({
    type,
    src,
    dst
...
var getRelationships = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => relations, "getRelationships");
var clear2 = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => {
  relations = [];
  latestRequirement = {};
...
var requirementDb_default = {
  ...
  VerifyType,
  Relationships,
  getConfig: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .D7)().req, "getConfig"),
  addRequirement,
  getRequirements,
  setNewReqId,
  setNewReqText,
...
var insertLineEndings = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((parentNode, conf2) => {
...
var conf = {};
var relCnt = 0;
var newRectNode = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((parentNode, id) => {
...
var newTitleNode = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((parentNode, id, txts) => {
...
var newBodyNode = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((parentNode, id, txts, yStart) => {
...
var addEdgeLabel = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((parentNode, svgPath, conf2, txt) => {
...
var drawRelationshipFromLayout = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(svg, rel, g, insert, diagObj) {
  ...
  if (rel.type == diagObj.db.Relationships.CONTAINS) {
    svgPath.attr(
      "marker-start",
      "url(" + _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .common_default */ .Y2.getUrl(conf.arrowMarkerAbsolute) + "#" + rel.type + "_line_ending)"
    );
  } else {
    svgPath.attr("stroke-dasharray", "10,7");
    svgPath.attr(
      "marker-end",
      "url(" + _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .common_default */ .Y2.getUrl(conf.arrowMarkerAbsolute) + "#" + requirementMarkers_default.ReqMarkers.ARROW + "_line_ending)"
    );
  }
  addEdgeLabel(svg, svgPath, conf, `<<${rel.type}>>`);
  return;
}, "drawRelationshipFromLayout");
var drawReqs = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((reqs, graph, svgNode) => {
  reqs.forEach((req, reqName) => {
    reqName = elementString(reqName);
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .Rm.info("Added new requirement: ", reqName);
...
var drawElements = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((els, graph, svgNode) => {
...
var addRelationships = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((relationships, g) => {
...
var adjustEntities = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(svgNode, graph) {
...
var elementString = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((str) => {
  return str.replace(/\s/g, "").replace(/\./g, "_");
}, "elementString");
var draw = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((text, id, _version, diagObj) => {
  conf = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .D7)().requirement;
  ...
  (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .configureSvgSize */ .a$)(svg, height, width, conf.useMaxWidth);
