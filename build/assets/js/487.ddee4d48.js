...
/* harmony export */ });
/* harmony import */ var _chunk_DUMQOTYW_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(87643);
/* harmony import */ var _chunk_WSMKYKZ5_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(46504);
...
var getDir = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
var getClasses = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(text, diagramObj) {
  diagramObj.db.extract(diagramObj.db.getRootDocV2());
  return diagramObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(async function(text, id, _version, diag) {
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("REF0:");
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Drawing state diagram (v2)", id);
  const { securityLevel, state: conf, layout } = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
  diag.db.extract(diag.db.getRootDocV2());
  const data4Layout = diag.db.getData();
  const svg = (0,_chunk_DUMQOTYW_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getDiagramElement */ .A)(id, securityLevel);
  ...
  await (0,_chunk_WSMKYKZ5_mjs__WEBPACK_IMPORTED_MODULE_1__/* .render */ .XX)(data4Layout, svg);
  const padding = 8;
  _chunk_2EDTWDYI_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default */ ._K.insertTitle(
    svg,
    "statediagramTitleText",
    conf?.titleTopMargin ?? 25,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_DUMQOTYW_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setupViewPortForSVG */ .P)(svg, padding, CSS_DIAGRAM, conf?.useMaxWidth ?? true);
}, "draw");
...
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(stateDomId, "stateDomId");
var setupDoc = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((parentParsedItem, doc, diagramStates, nodes2, edges2, altFlag, look, classes2) => {
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.trace("items", doc);
  doc.forEach((item) => {
    switch (item.stmt) {
      case STMT_STATE:
      ...
      case STMT_RELATION:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(item.description, (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)()),
...
var getDir2 = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  let dir = defaultDir;
  if (parsedItem.doc) {
    for (const parsedItemDoc of parsedItem.doc) {
      if (parsedItemDoc.stmt === "dir") {
...
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(insertOrUpdateNode, "insertOrUpdateNode");
function getClassesFromDbInfo(dbInfoItem) {
  return dbInfoItem?.classes?.join(" ") ?? "";
}
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getClassesFromDbInfo, "getClassesFromDbInfo");
function getStylesFromDbInfo(dbInfoItem) {
  return dbInfoItem?.styles ?? [];
}
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getStylesFromDbInfo, "getStylesFromDbInfo");
var dataFetcher = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((parent, parsedItem, diagramStates, nodes2, edges2, altFlag, look, classes2) => {
  const itemId = parsedItem.id;
  const dbState = diagramStates.get(itemId);
  const classStr = getClassesFromDbInfo(dbState);
  const style = getStylesFromDbInfo(dbState);
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("dataFetcher parsedItem", parsedItem, dbState, style);
  if (itemId !== "root") {
    ...
    if (!nodeDb.get(itemId)) {
      nodeDb.set(itemId, {
        id: itemId,
        shape,
        description: _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(itemId, (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)()),
    ...
    if (parsedItem.description) {
      ...
      newNode.description = _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeTextOrArray(newNode.description, (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)());
    }
    ...
    if (!newNode.type && parsedItem.doc) {
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Setting cluster for XCX", itemId, getDir2(parsedItem));
      newNode.type = "group";
    ...
    if (parent && parent.id !== "root") {
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.trace("Setting node ", itemId, " to be child of its parent ", parent.id);
    ...
    if (parsedItem.note) {
      const noteData = {
        ...
        type: newNode.type,
        isGroup: newNode.type === "group",
        padding: (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)().flowchart.padding,
        look,
  ...
  if (parsedItem.doc) {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.trace("Adding nodes children ");
    setupDoc(parsedItem, parsedItem.doc, diagramStates, nodes2, edges2, !altFlag, look, classes2);
  }
}, "dataFetcher");
var reset = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => {
  nodeDb.clear();
  graphItemCount = 0;
}, "reset");
...
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(newClassesList, "newClassesList");
var nodes = [];
var edges = [];
var direction = DEFAULT_DIAGRAM_DIRECTION;
var rootDoc = [];
var classes = newClassesList();
var newDoc = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => {
  return {
...
var clone = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((o) => JSON.parse(JSON.stringify(o)), "clone");
var setRootDoc = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((o) => {
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Setting root doc", o);
  rootDoc = o;
}, "setRootDoc");
var getRootDoc = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => rootDoc, "getRootDoc");
var docTranslator = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((parent, node, first) => {
  if (node.stmt === STMT_RELATION) {
    ...
    if (node.doc) {
      ...
      if (doc.length > 0 && currentDoc.length > 0) {
        const newNode = {
          stmt: STMT_STATE,
          id: (0,_chunk_2EDTWDYI_mjs__WEBPACK_IMPORTED_MODULE_2__/* .generateId */ .$C)(),
          type: "divider",
...
var getRootDocV2 = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => {
  docTranslator({ id: "root" }, { id: "root", doc: rootDoc }, true);
  return { id: "root", doc: rootDoc };
}, "getRootDocV2");
var extract = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((_doc) => {
  let doc;
  if (_doc.doc) {
    doc = _doc.doc;
  } else {
  ...
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info(doc);
  clear2(true);
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Extract initial document:", doc);
  doc.forEach((item) => {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.warn("Statement", item.stmt);
    switch (item.stmt) {
      case STMT_STATE:
        addState(
          item.id.trim(),
  ...
  const config = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
...
var addState = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(id, type = DEFAULT_STATE_TYPE, doc = null, descr = null, note = null, classes2 = null, styles = null, textStyles = null) {
  const trimmedId = id?.trim();
  if (!currentDocument.states.has(trimmedId)) {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Adding state ", trimmedId, descr);
  ...
  if (descr) {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Setting state description", trimmedId, descr);
  ...
  if (note) {
    ...
    doc2.note = note;
    doc2.note.text = _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(doc2.note.text, (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)());
  }
  if (classes2) {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Setting state classes", trimmedId, classes2);
  ...
  if (styles) {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Setting state styles", trimmedId, styles);
...
var clear2 = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(saveCommon) {
  nodes = [];
  edges = [];
  documents = {
    root: newDoc()
...
var getState = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(id) {
  return currentDocument.states.get(id);
}, "getState");
var getStates = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
  return currentDocument.states;
}, "getStates");
var logDocuments = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Documents = ", documents);
}, "logDocuments");
var getRelations = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
...
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(startIdIfNeeded, "startIdIfNeeded");
function startTypeIfNeeded(id = "", type = DEFAULT_STATE_TYPE) {
  return id === START_NODE ? START_TYPE : type;
}
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(startTypeIfNeeded, "startTypeIfNeeded");
...
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(endIdIfNeeded, "endIdIfNeeded");
function endTypeIfNeeded(id = "", type = DEFAULT_STATE_TYPE) {
  return id === END_NODE ? END_TYPE : type;
}
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(endTypeIfNeeded, "endTypeIfNeeded");
function addRelationObjs(item1, item2, relationTitle) {
  ...
  currentDocument.relations.push({
    id1,
    id2,
    relationTitle: _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(relationTitle, (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)())
  });
}
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(addRelationObjs, "addRelationObjs");
var addRelation = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(item1, item2, title) {
  if (typeof item1 === "object") {
    ...
    currentDocument.relations.push({
      id1,
      id2,
      title: _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(title, (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)())
    });
  }
}, "addRelation");
var addDescription = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(id, descr) {
  const theState = currentDocument.states.get(id);
  const _descr = descr.startsWith(":") ? descr.replace(":", "").trim() : descr;
  theState.descriptions.push(_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(_descr, (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)()));
}, "addDescription");
var cleanupLabel = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(label) {
...
var getDividerId = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => {
  dividerCnt++;
  return "divider-id-" + dividerCnt;
}, "getDividerId");
var addStyleClass = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(id, styleAttributes = "") {
  if (!classes.has(id)) {
...
var getClasses2 = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
  return classes;
}, "getClasses");
var setCssClass = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(itemIds, cssClassName) {
...
var setStyle = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(itemId, styleText) {
  const item = getState(itemId);
  if (item !== void 0) {
    item.styles.push(styleText);
  }
}, "setStyle");
var setTextStyle = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(itemId, cssClassName) {
  const item = getState(itemId);
  if (item !== void 0) {
    item.textStyles.push(cssClassName);
  }
}, "setTextStyle");
var getDirection = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => direction, "getDirection");
var setDirection = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((dir) => {
  direction = dir;
}, "setDirection");
var trimColon = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((str) => str && str[0] === ":" ? str.substr(1).trim() : str.trim(), "trimColon");
var getData = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => {
  const config = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
  return { nodes, edges, other: {}, config, direction: getDir(getRootDocV2()) };
}, "getData");
var stateDb_default = {
  getConfig: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)().state, "getConfig"),
  getData,
  addState,
  clear: clear2,
  getState,
...
var getStyles = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((options) => `
...
var getDiagramElement = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((id, securityLevel) => {
  let sandboxElement;
...
var setupViewPortForSVG = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((svg, padding, cssDiagram, useMaxWidth) => {
  svg.attr("class", cssDiagram);
  const { width, height, x, y } = calculateDimensionsWithPadding(svg, padding);
  (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .configureSvgSize */ .a$)(svg, height, width, useMaxWidth);
  const viewBox = createViewBox(x, y, width, height, padding);
  svg.attr("viewBox", viewBox);
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .Rm.debug(`viewBox configured: ${viewBox} with padding: ${padding}`);
}, "setupViewPortForSVG");
var calculateDimensionsWithPadding = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((svg, padding) => {
...
var createViewBox = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((x, y, width, height, padding) => {
...
/* harmony export */ });
/* harmony import */ var _chunk_5N55DQE6_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(27673);
/* harmony import */ var _chunk_2EDTWDYI_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(36553);
/* harmony import */ var _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(64422);
...
/* harmony export */ });
/* harmony import */ var _chunk_2JBRQKJ5_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6302);
/* harmony import */ var _chunk_DUMQOTYW_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(87643);
/* harmony import */ var _chunk_YWFND7JV_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(97190);
/* harmony import */ var _chunk_WSMKYKZ5_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(46504);
/* harmony import */ var _chunk_VR7AIV22_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7936);
/* harmony import */ var _chunk_23ATMZXV_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(43620);
/* harmony import */ var _chunk_5N55DQE6_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(27673);
/* harmony import */ var _chunk_2EDTWDYI_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(36553);
/* harmony import */ var _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(64422);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(20007);
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(62334);
...
var idCache = {};
var set = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)((key, val) => {
  idCache[key] = val;
}, "set");
var get = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)((k) => idCache[k], "get");
var keys = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)(() => Object.keys(idCache), "keys");
var size = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)(() => keys().length, "size");
...
// src/diagrams/state/shapes.js
var drawStartState = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)((g) => g.append("circle").attr("class", "start-state").attr("r", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.sizeUnit).attr("cx", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.sizeUnit).attr("cy", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.sizeUnit), "drawStartState");
var drawDivider = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)((g) => g.append("line").style("stroke", "grey").style("stroke-dasharray", "3").attr("x1", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.textHeight).attr("class", "divider").attr("x2", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.textHeight * 2).attr("y1", 0).attr("y2", 0), "drawDivider");
var drawSimpleState = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)((g, stateDef) => {
  const state = g.append("text").attr("x", 2 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).attr("y", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.textHeight + 2 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).attr("font-size", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.fontSize).attr("class", "state-title").text(stateDef.id);
  const classBox = state.node().getBBox();
  g.insert("rect", ":first-child").attr("x", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).attr("y", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).attr("width", classBox.width + 2 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).attr("height", classBox.height + 2 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).attr("rx", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.radius);
  return state;
}, "drawSimpleState");
var drawDescrState = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)((g, stateDef) => {
  const addTspan = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)(function(textEl, txt, isFirst2) {
    const tSpan = textEl.append("tspan").attr("x", 2 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).text(txt);
    if (!isFirst2) {
      tSpan.attr("dy", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.textHeight);
    }
  }, "addTspan");
  const title = g.append("text").attr("x", 2 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).attr("y", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.textHeight + 1.3 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).attr("font-size", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.fontSize).attr("class", "state-title").text(stateDef.descriptions[0]);
  const titleBox = title.node().getBBox();
  const titleHeight = titleBox.height;
  const description = g.append("text").attr("x", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).attr(
    "y",
    titleHeight + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding * 0.4 + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.dividerMargin + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.textHeight
  ...
  const descrLine = g.append("line").attr("x1", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).attr("y1", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding + titleHeight + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.dividerMargin / 2).attr("y2", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding + titleHeight + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.dividerMargin / 2).attr("class", "descr-divider");
  const descrBox = description.node().getBBox();
  const width = Math.max(descrBox.width, titleBox.width);
  descrLine.attr("x2", width + 3 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding);
  g.insert("rect", ":first-child").attr("x", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).attr("y", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).attr("width", width + 2 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).attr("height", descrBox.height + titleHeight + 2 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).attr("rx", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.radius);
  return g;
}, "drawDescrState");
var addTitleAndBox = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)((g, stateDef, altBkg) => {
  const pad = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding;
  const dblPad = 2 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding;
  const orgBox = g.node().getBBox();
  const orgWidth = orgBox.width;
  const orgX = orgBox.x;
  const title = g.append("text").attr("x", 0).attr("y", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.titleShift).attr("font-size", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.fontSize).attr("class", "state-title").text(stateDef.id);
  const titleBox = title.node().getBBox();
  ...
  const lineY = 1 - (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.textHeight;
  g.insert("rect", ":first-child").attr("x", startX).attr("y", lineY).attr("class", altBkg ? "alt-composit" : "composit").attr("width", width).attr(
    "height",
    graphBox.height + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.textHeight + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.titleShift + 1
  ).attr("rx", "0");
  ...
  g.insert("rect", ":first-child").attr("x", startX).attr(
    "y",
    (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.titleShift - (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.textHeight - (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding
  ).attr("width", width).attr("height", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.textHeight * 3).attr("rx", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.radius);
  g.insert("rect", ":first-child").attr("x", startX).attr(
    "y",
    (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.titleShift - (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.textHeight - (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding
  ).attr("width", width).attr("height", graphBox.height + 3 + 2 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.textHeight).attr("rx", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.radius);
  return g;
}, "addTitleAndBox");
var drawEndState = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)((g) => {
  g.append("circle").attr("class", "end-state-outer").attr("r", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.sizeUnit + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.miniPadding).attr(
    "cx",
    (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.sizeUnit + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.miniPadding
  ).attr(
    "cy",
    (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.sizeUnit + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.miniPadding
  );
  return g.append("circle").attr("class", "end-state-inner").attr("r", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.sizeUnit).attr("cx", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.sizeUnit + 2).attr("cy", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.sizeUnit + 2);
}, "drawEndState");
var drawForkJoinState = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)((g, stateDef) => {
  let width = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.forkWidth;
  let height = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.forkHeight;
  if (stateDef.parentId) {
    let tmp = width;
    width = height;
    height = tmp;
  }
  return g.append("rect").style("stroke", "black").style("fill", "black").attr("width", width).attr("height", height).attr("x", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).attr("y", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding);
}, "drawForkJoinState");
var _drawLongText = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)((_text, x, y, g) => {
  let textHeight = 0;
  ...
  text = text.replace(/\n/g, "<br/>");
  const lines = text.split(_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .common_default */ .Y2.lineBreakRegex);
  let tHeight = 1.25 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.noteMargin;
  for (const line2 of lines) {
    ...
    if (txt.length > 0) {
      ...
      textHeight += tHeight;
      span.attr("x", x + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.noteMargin);
      span.attr("y", y + textHeight + 1.25 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.noteMargin);
    }
  }
  return { textWidth: textElem.node().getBBox().width, textHeight };
}, "_drawLongText");
var drawNote = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)((text, g) => {
  g.attr("class", "state-note");
  const note = g.append("rect").attr("x", 0).attr("y", (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding);
  const rectElem = g.append("g");
  const { textWidth, textHeight } = _drawLongText(text, 0, 0, rectElem);
  note.attr("height", textHeight + 2 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.noteMargin);
  note.attr("width", textWidth + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.noteMargin * 2);
  return note;
}, "drawNote");
var drawState = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)(function(elem, stateDef) {
  ...
  stateInfo.width = stateBox.width + 2 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding;
  stateInfo.height = stateBox.height + 2 * (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding;
  id_cache_default.set(id, stateInfo);
  return stateInfo;
}, "drawState");
var edgeCount = 0;
var drawEdge = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)(function(elem, path, relation) {
  const getRelationType = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)(function(type) {
    switch (type) {
      case _chunk_2JBRQKJ5_mjs__WEBPACK_IMPORTED_MODULE_0__/* .stateDb_default */ .iP.relationType.AGGREGATION:
        return "aggregation";
      case _chunk_2JBRQKJ5_mjs__WEBPACK_IMPORTED_MODULE_0__/* .stateDb_default */ .iP.relationType.EXTENSION:
        return "extension";
      case _chunk_2JBRQKJ5_mjs__WEBPACK_IMPORTED_MODULE_0__/* .stateDb_default */ .iP.relationType.COMPOSITION:
        return "composition";
      case _chunk_2JBRQKJ5_mjs__WEBPACK_IMPORTED_MODULE_0__/* .stateDb_default */ .iP.relationType.DEPENDENCY:
        return "dependency";
    }
  }, "getRelationType");
  ...
  let url = "";
  if ((0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.arrowMarkerAbsolute) {
  ...
  svgPath.attr(
    "marker-end",
    "url(" + url + "#" + getRelationType(_chunk_2JBRQKJ5_mjs__WEBPACK_IMPORTED_MODULE_0__/* .stateDb_default */ .iP.relationType.DEPENDENCY) + "End)"
  );
  if (relation.title !== void 0) {
    const label = elem.append("g").attr("class", "stateLabel");
    const { x, y } = _chunk_2EDTWDYI_mjs__WEBPACK_IMPORTED_MODULE_7__/* .utils_default */ ._K.calcLabelPosition(path.points);
    const rows = _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .common_default */ .Y2.getRows(relation.title);
    let titleHeight = 0;
    const titleRows = [];
    let maxWidth = 0;
    let minX = 0;
    for (let i = 0; i <= rows.length; i++) {
      ...
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .log */ .Rm.info(boundsTmp.x, x, y + titleHeight);
      if (titleHeight === 0) {
        const titleBox = title.node().getBBox();
        titleHeight = titleBox.height;
        _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .log */ .Rm.info("Title height", titleHeight, y);
      }
    ...
    label.insert("rect", ":first-child").attr("class", "box").attr("x", x - maxWidth / 2 - (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding / 2).attr("y", y - boxHeight / 2 - (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding / 2 - 3.5).attr("width", maxWidth + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding).attr("height", boxHeight + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state.padding);
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .log */ .Rm.info(bounds);
  }
  edgeCount++;
}, "drawEdge");
...
var setConf = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)(function() {
}, "setConf");
var insertMarkers = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)(function(elem) {
  elem.append("defs").append("marker").attr("id", "dependencyEnd").attr("refX", 19).attr("refY", 7).attr("markerWidth", 20).attr("markerHeight", 28).attr("orient", "auto").append("path").attr("d", "M 19,7 L9,13 L14,7 L9,1 Z");
}, "insertMarkers");
var draw = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)(function(text, id, _version, diagObj) {
  conf = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().state;
  const securityLevel = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .getConfig2 */ .D7)().securityLevel;
  let sandboxElement;
  if (securityLevel === "sandbox") {
  ...
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .log */ .Rm.debug("Rendering diagram " + text);
  ...
  (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .configureSvgSize */ .a$)(diagram2, height, svgWidth, conf.useMaxWidth);
  diagram2.attr(
    "viewBox",
    `${bounds.x - conf.padding}  ${bounds.y - conf.padding} ` + width + " " + height
  );
}, "draw");
var getLabelWidth = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)((text) => {
  return text ? text.length * conf.fontSizeFactor : 1;
}, "getLabelWidth");
var renderDoc = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)((doc, diagram2, parentId, altBkg, root, domDocument, diagObj) => {
  ...
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .log */ .Rm.debug("Count=", graph.nodeCount(), graph);
  let cnt = 0;
  relations.forEach(function(relation) {
    cnt++;
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .log */ .Rm.debug("Setting edge", relation);
    graph.setEdge(
      relation.id1,
      relation.id2,
      {
        ...
        height: conf.labelHeight * _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .common_default */ .Y2.getRows(relation.title).length,
        labelpos: "c"
      },
      "id" + cnt
    );
  ...
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .log */ .Rm.debug("Graph after layout", graph.nodes());
  const svgElem = diagram2.node();
  graph.nodes().forEach(function(v) {
    if (v !== void 0 && graph.node(v) !== void 0) {
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .log */ .Rm.warn("Node " + v + ": " + JSON.stringify(graph.node(v)));
      ...
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .log */ .Rm.debug("No Node " + v + ": " + JSON.stringify(graph.node(v)));
    }
  });
  let stateBox = svgElem.getBBox();
  graph.edges().forEach(function(e) {
    if (e !== void 0 && graph.edge(e) !== void 0) {
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .log */ .Rm.debug("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(graph.edge(e)));
  ...
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .log */ .Rm.debug("Doc rendered", stateInfo, graph);
  return stateInfo;
}, "renderDoc");
...
var diagram = {
  parser: _chunk_2JBRQKJ5_mjs__WEBPACK_IMPORTED_MODULE_0__/* .stateDiagram_default */ .Zk,
  db: _chunk_2JBRQKJ5_mjs__WEBPACK_IMPORTED_MODULE_0__/* .stateDb_default */ .iP,
  renderer: stateRenderer_default,
  styles: _chunk_2JBRQKJ5_mjs__WEBPACK_IMPORTED_MODULE_0__/* .styles_default */ .tM,
  init: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K2)((cnf) => {
    if (!cnf.state) {
      cnf.state = {};
    }
    cnf.state.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    _chunk_2JBRQKJ5_mjs__WEBPACK_IMPORTED_MODULE_0__/* .stateDb_default */ .iP.clear();
  }, "init")
};
