...
/* harmony export */ });
/* harmony import */ var _chunk_BAVOGKFW_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12664);
...
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(62334);
...
var edgeCount = 0;
var drawEdge = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K2)(function(elem, path, relation, conf, diagObj) {
  const getRelationType = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K2)(function(type) {
    switch (type) {
  ...
  let labelPosition = _chunk_2EDTWDYI_mjs__WEBPACK_IMPORTED_MODULE_1__/* .utils_default */ ._K.calcLabelPosition(path.points);
  x = labelPosition.x;
  y = labelPosition.y;
  let p1_card_x, p1_card_y;
  let p2_card_x, p2_card_y;
  if (l % 2 !== 0 && l > 1) {
    let cardinality_1_point = _chunk_2EDTWDYI_mjs__WEBPACK_IMPORTED_MODULE_1__/* .utils_default */ ._K.calcCardinalityPosition(
      relation.relation.type1 !== "none",
      path.points,
      path.points[0]
    );
    let cardinality_2_point = _chunk_2EDTWDYI_mjs__WEBPACK_IMPORTED_MODULE_1__/* .utils_default */ ._K.calcCardinalityPosition(
      relation.relation.type2 !== "none",
      path.points,
      path.points[l - 1]
    );
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log */ .Rm.debug("cardinality_1_point " + JSON.stringify(cardinality_1_point));
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log */ .Rm.debug("cardinality_2_point " + JSON.stringify(cardinality_2_point));
  ...
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log */ .Rm.info("Rendering relation " + JSON.stringify(relation));
...
var drawClass = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K2)(function(elem, classDef, conf, diagObj) {
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log */ .Rm.debug("Rendering class ", classDef, conf);
...
var getClassTitleString = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K2)(function(classDef) {
  let classTitleString = classDef.id;
  if (classDef.type) {
    classTitleString += "<" + (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .parseGenericTypes */ .QO)(classDef.type) + ">";
  }
  return classTitleString;
}, "getClassTitleString");
var drawNote = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K2)(function(elem, note, conf, _diagObj) {
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log */ .Rm.debug("Rendering note ", note, conf);
  const id = note.id;
  const noteInfo = {
    id,
    text: note.text,
  ...
  lines.forEach(function(line2) {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log */ .Rm.debug(`Adding line: ${line2}`);
...
var addTspan = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K2)(function(textEl, member, isFirst, conf) {
...
var idCache = {};
var padding = 20;
var getGraphId = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K2)(function(label) {
  const foundEntry = Object.entries(idCache).find((entry) => entry[1].label === label);
  if (foundEntry) {
    return foundEntry[0];
  }
}, "getGraphId");
var insertMarkers = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K2)(function(elem) {
...
var draw = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K2)(function(text, id, _version, diagObj) {
  const conf = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig2 */ .D7)().class;
  idCache = {};
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log */ .Rm.info("Rendering diagram " + text);
  ...
  for (const key of keys) {
    ...
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log */ .Rm.info("Org height: " + node.height);
  }
  const relations = diagObj.db.getRelations();
  relations.forEach(function(relation) {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log */ .Rm.info(
      // cspell:ignore tjoho
  ...
  notes.forEach(function(note) {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log */ .Rm.debug(`Adding note: ${JSON.stringify(note)}`);
  ...
  g.nodes().forEach(function(v) {
    if (v !== void 0 && g.node(v) !== void 0) {
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log */ .Rm.debug("Node " + v + ": " + JSON.stringify(g.node(v)));
  ...
  g.edges().forEach(function(e) {
    if (e !== void 0 && g.edge(e) !== void 0) {
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log */ .Rm.debug("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(g.edge(e)));
  ...
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .log */ .Rm.debug(`viewBox ${vBox}`);
...
var diagram = {
  parser: _chunk_BAVOGKFW_mjs__WEBPACK_IMPORTED_MODULE_0__/* .classDiagram_default */ ._$,
  db: _chunk_BAVOGKFW_mjs__WEBPACK_IMPORTED_MODULE_0__/* .classDb_default */ .z2,
  renderer: classRenderer_default,
  styles: _chunk_BAVOGKFW_mjs__WEBPACK_IMPORTED_MODULE_0__/* .styles_default */ .tM,
  init: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .__name */ .K2)((cnf) => {
    if (!cnf.class) {
      cnf.class = {};
    }
    cnf.class.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    _chunk_BAVOGKFW_mjs__WEBPACK_IMPORTED_MODULE_0__/* .classDb_default */ .z2.clear();
  }, "init")
};
