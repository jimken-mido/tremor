...
var updateActors = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function() {
  const tempActors = [];
  tasks.forEach((task) => {
    if (task.people) {
...
var addTask = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(descr, taskData) {
...
var addTaskOrg = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(descr) {
  const newTask = {
    section: currentSection,
    type: currentSection,
    description: descr,
...
var getActors = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function() {
  return updateActors();
}, "getActors");
var journeyDb_default = {
  getConfig: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(() => (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)().journey, "getConfig"),
  clear: clear2,
...
var getStyles = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)((options) => `.label {
...
var drawRect2 = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(elem, rectData) {
  return (0,_chunk_XVOYOM2C_mjs__WEBPACK_IMPORTED_MODULE_0__/* .drawRect */ .tk)(elem, rectData);
}, "drawRect");
var drawFace = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(element, faceData) {
  const radius = 15;
  ...
  (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(smile, "smile");
  function sad(face2) {
  ...
  (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(sad, "sad");
  function ambivalent(face2) {
    face2.append("line").attr("class", "mouth").attr("stroke", 2).attr("x1", faceData.cx - 5).attr("y1", faceData.cy + 7).attr("x2", faceData.cx + 5).attr("y2", faceData.cy + 7).attr("class", "mouth").attr("stroke-width", "1px").attr("stroke", "#666");
  }
  (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(ambivalent, "ambivalent");
  if (faceData.score > 3) {
    smile(face);
...
var drawCircle = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(element, circleData) {
...
var drawText2 = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(elem, textData) {
  return (0,_chunk_XVOYOM2C_mjs__WEBPACK_IMPORTED_MODULE_0__/* .drawText */ .m)(elem, textData);
}, "drawText");
var drawLabel = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(elem, txtObject) {
  function genPoints(x, y, width, height, cut) {
    return x + "," + y + " " + (x + width) + "," + y + " " + (x + width) + "," + (y + height - cut) + " " + (x + width - cut * 1.2) + "," + (y + height) + " " + x + "," + (y + height);
  }
  (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(genPoints, "genPoints");
...
var drawSection = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(elem, section, conf2) {
...
var taskCount = -1;
var drawTask = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(elem, task, conf2) {
...
var drawBackgroundRect2 = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(elem, bounds2) {
...
var _drawTextCandidateFunc = /* @__PURE__ */ function() {
  ...
  (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(byText, "byText");
  ...
  (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(byTspan, "byTspan");
  ...
  (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(byFo, "byFo");
  ...
  (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(_setTextAttrs, "_setTextAttrs");
  return function(conf2) {
    return conf2.textPlacement === "fo" ? byFo : conf2.textPlacement === "old" ? byText : byTspan;
  };
}();
var initGraphics = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(graphics) {
...
// src/diagrams/user-journey/journeyRenderer.ts
var setConf = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(cnf) {
...
function drawActorLegend(diagram2) {
  const conf2 = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)().journey;
  let yPos = 60;
...
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(drawActorLegend, "drawActorLegend");
var conf = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)().journey;
...
var draw = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(text, id, version, diagObj) {
  ...
  (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .configureSvgSize */ .a$)(diagram2, height, width, conf2.useMaxWidth);
...
var bounds = {
  ...
  verticalPos: 0,
  sequenceItems: [],
  init: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function() {
    this.sequenceItems = [];
    this.data = {
      startx: void 0,
      stopx: void 0,
  ...
  updateVal: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(obj, key, val, fun) {
    if (obj[key] === void 0) {
      obj[key] = val;
    } else {
  ...
  updateBounds: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(startx, starty, stopx, stopy) {
    const conf2 = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)().journey;
    const _self = this;
    let cnt = 0;
    function updateFn(type) {
      return /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function updateItemBounds(item) {
        cnt++;
    ...
    (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(updateFn, "updateFn");
    this.sequenceItems.forEach(updateFn());
  }, "updateBounds"),
  insert: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(startx, starty, stopx, stopy) {
  ...
  bumpVerticalPos: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(bump) {
    this.verticalPos = this.verticalPos + bump;
    this.data.stopy = this.verticalPos;
  }, "bumpVerticalPos"),
  getVerticalPos: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function() {
    return this.verticalPos;
  }, "getVerticalPos"),
  getBounds: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function() {
    return this.data;
  }, "getBounds")
};
var fills = conf.sectionFills;
var textColours = conf.sectionColours;
var drawTasks = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(diagram2, tasks2, verticalPos) {
  const conf2 = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)().journey;
  let lastSection = "";
...
var diagram = {
  ...
  init: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)((cnf) => {
