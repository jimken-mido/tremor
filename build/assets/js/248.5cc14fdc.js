...
/* harmony export */ });
/* harmony import */ var _chunk_VR7AIV22_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7936);
/* harmony import */ var _chunk_23ATMZXV_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(43620);
/* harmony import */ var _chunk_5N55DQE6_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(27673);
/* harmony import */ var _chunk_2EDTWDYI_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(36553);
/* harmony import */ var _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(64422);
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(62334);
/* harmony import */ var dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(14075);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(697);
...
var clear4 = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(() => {
  descendants.clear();
  parents.clear();
  clusterDb.clear();
}, "clear");
var isDescendant = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((id, ancestorId) => {
  const ancestorDescendants = descendants.get(ancestorId) || [];
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.trace("In isDescendant", ancestorId, " ", id, " = ", ancestorDescendants.includes(id));
  return ancestorDescendants.includes(id);
}, "isDescendant");
var edgeInCluster = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((edge, clusterId) => {
  const clusterDescendants = descendants.get(clusterId) || [];
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Descendants of ", clusterId, " is ", clusterDescendants);
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Edge is ", edge);
  if (edge.v === clusterId || edge.w === clusterId) {
    return false;
  }
  if (!clusterDescendants) {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("Tilt, ", clusterId, ",not in descendants");
    return false;
  }
  return clusterDescendants.includes(edge.v) || isDescendant(edge.v, clusterId) || isDescendant(edge.w, clusterId) || clusterDescendants.includes(edge.w);
}, "edgeInCluster");
var copy = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((clusterId, graph, newGraph, rootId) => {
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn(
    "Copying children of ",
    clusterId,
    "root",
    rootId,
  ...
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("Copying (nodes) clusterId", clusterId, "nodes", nodes);
  nodes.forEach((node) => {
    if (graph.children(node).length > 0) {
      copy(node, graph, newGraph, rootId);
    } else {
      const data = graph.node(node);
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("cp ", node, " to ", rootId, " with parent ", clusterId);
      newGraph.setNode(node, data);
      if (rootId !== graph.parent(node)) {
        _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("Setting parent", node, graph.parent(node));
        newGraph.setParent(node, graph.parent(node));
      }
      if (clusterId !== rootId && node !== clusterId) {
        _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("Setting parent", node, clusterId);
        newGraph.setParent(node, clusterId);
      } else {
        _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("In copy ", clusterId, "root", rootId, "data", graph.node(clusterId), rootId);
      ...
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("Copying Edges", edges);
      edges.forEach((edge) => {
        _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Edge", edge);
        const data2 = graph.edge(edge.v, edge.w, edge.name);
        _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Edge data", data2, rootId);
        try {
          if (edgeInCluster(edge, rootId)) {
            _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Copying as ", edge.v, edge.w, data2, edge.name);
            newGraph.setEdge(edge.v, edge.w, data2, edge.name);
            _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("newGraph edges ", newGraph.edges(), newGraph.edge(newGraph.edges()[0]));
          } else {
            _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info(
          ...
          _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.error(e);
        }
      });
    }
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("Removing node", node);
    graph.removeNode(node);
  });
}, "copy");
var extractDescendants = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((id, graph) => {
...
var findCommonEdges = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((graph, id1, id2) => {
...
var findNonClusterChild = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((id, graph, clusterId) => {
  const children = graph.children(id);
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.trace("Searching children of id ", id, children);
...
var getAnchorId = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((id) => {
  if (!clusterDb.has(id)) {
    return id;
  }
...
var adjustClustersAndEdges = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((graph, depth) => {
  if (!graph || depth > 10) {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("Opting out, no graph ");
    return;
  } else {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("Opting in, graph ");
  }
  ...
  graph.nodes().forEach(function(id) {
    ...
    if (children.length > 0) {
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("Cluster identified", id, descendants);
      edges.forEach((edge) => {
        const d1 = isDescendant(edge.v, id);
        const d2 = isDescendant(edge.w, id);
        if (d1 ^ d2) {
          _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("Edge: ", edge, " leaves cluster ", id);
          _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("Descendants of XXX ", id, ": ", descendants.get(id));
          clusterDb.get(id).externalConnections = true;
        }
      });
    } else {
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("Not a cluster ", id, descendants);
    }
  });
  ...
  graph.edges().forEach(function(e) {
    ...
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(e));
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(graph.edge(e)));
    let v = e.v;
    let w = e.w;
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn(
      "Fix XXX",
    ...
    if (clusterDb.get(e.v) || clusterDb.get(e.w)) {
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("Fixing and trying - removing XXX", e.v, e.w, e.name);
      v = getAnchorId(e.v);
      w = getAnchorId(e.w);
      ...
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("Fix Replacing with XXX", v, w, e.name);
      graph.setEdge(v, w, edge, e.name);
    }
  });
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("Adjusted Graph", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_6__/* .write */ .M(graph));
  extractor(graph, 0);
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.trace(clusterDb);
}, "adjustClustersAndEdges");
var extractor = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((graph, depth) => {
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("extractor - ", depth, dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_6__/* .write */ .M(graph), graph.children("D"));
  if (depth > 10) {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.error("Bailing out");
    return;
  }
  ...
  if (!hasChildren) {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("Done, no node has children", graph.nodes());
    return;
  }
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("Nodes = ", nodes, depth);
  for (const node of nodes) {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug(
      "Extracting node",
      node,
    ...
    if (!clusterDb.has(node)) {
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("Not a cluster", node, depth);
      ...
      if (clusterDb.get(node)?.clusterData?.dir) {
        ...
        _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("Fixing dir", clusterDb.get(node).clusterData.dir, dir);
      }
      ...
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("Old graph before copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_6__/* .write */ .M(graph));
      ...
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("New graph after copy node: (", node, ")", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_6__/* .write */ .M(clusterGraph));
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("Old graph after copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_6__/* .write */ .M(graph));
    } else {
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn(
        "Cluster ** ",
        node,
      ...
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug(clusterDb);
    }
  }
  nodes = graph.nodes();
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("New list of nodes", nodes);
  for (const node of nodes) {
    const data = graph.node(node);
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn(" Now next level", node, data);
    if (data?.clusterNode) {
      extractor(data.graph, depth + 1);
    }
  }
}, "extractor");
var sorter = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((graph, nodes) => {
  if (nodes.length === 0) {
    return [];
  }
...
var sortNodesByHierarchy = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((graph) => sorter(graph, graph.children()), "sortNodesByHierarchy");

// src/rendering-util/layout-algorithms/dagre/index.js
var recursiveRender = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(async (_elem, graph, diagramType, id, parentCluster, siteConfig) => {
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("Graph in recursive render:XAX", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_6__/* .write */ .M(graph), parentCluster);
  const dir = graph.graph().rankdir;
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.trace("Dir in recursive render - dir:", dir);
  const elem = _elem.insert("g").attr("class", "root");
  if (!graph.nodes()) {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("No nodes found for", graph);
  } else {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Recursive render XXX", graph.nodes());
  }
  if (graph.edges().length > 0) {
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Recursive edges", graph.edge(graph.edges()[0]));
  }
  ...
  await Promise.all(
    graph.nodes().map(async function(v) {
      ...
      if (parentCluster !== void 0) {
        ...
        _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.trace(
        ...
        if (!graph.parent(v)) {
          _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.trace("Setting parent", v, parentCluster.id);
          graph.setParent(v, parentCluster.id, data);
        }
      }
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("(Insert) Node XXX" + v + ": " + JSON.stringify(graph.node(v)));
      if (node?.clusterNode) {
        _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Cluster identified XBX", v, node.width, graph.node(v));
        ...
        const newEl = o.elem;
        (0,_chunk_VR7AIV22_mjs__WEBPACK_IMPORTED_MODULE_0__/* .updateNodeBounds */ .lC)(node, newEl);
        node.diff = o.diff || 0;
        _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info(
        ...
        (0,_chunk_VR7AIV22_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setNodeElem */ .U7)(newEl, node);
      } else {
        if (graph.children(v).length > 0) {
          ...
          _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.trace(findNonClusterChild(node.id, graph));
          clusterDb.set(node.id, { id: findNonClusterChild(node.id, graph), node });
        } else {
          _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.trace("Node - the non recursive path XAX", v, nodes, graph.node(v), dir);
          await (0,_chunk_VR7AIV22_mjs__WEBPACK_IMPORTED_MODULE_0__/* .insertNode */ .on)(nodes, graph.node(v), dir);
        }
      }
    })
  );
  const processEdges = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(async () => {
    const edgePromises = graph.edges().map(async function(e) {
      const edge = graph.edge(e.v, e.w, e.name);
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(e));
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Edge " + e.v + " -> " + e.w + ": ", e, " ", JSON.stringify(graph.edge(e)));
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info(
        "Fix",
        clusterDb,
        "ids:",
      ...
      await (0,_chunk_VR7AIV22_mjs__WEBPACK_IMPORTED_MODULE_0__/* .insertEdgeLabel */ .jP)(edgeLabels, edge);
    });
    await Promise.all(edgePromises);
  }, "processEdges");
  await processEdges();
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Graph before layout:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_6__/* .write */ .M(graph)));
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("############################################# XXX");
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("###                Layout                 ### XXX");
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("############################################# XXX");
  (0,dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_5__/* .layout */ .Zp)(graph);
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Graph after layout:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_6__/* .write */ .M(graph)));
  let diff = 0;
  let { subGraphTitleTotalMargin } = (0,_chunk_23ATMZXV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getSubGraphTitleMargins */ .O)(siteConfig);
  await Promise.all(
    sortNodesByHierarchy(graph).map(async function(v) {
      ...
      if (node?.clusterNode) {
        ...
        (0,_chunk_VR7AIV22_mjs__WEBPACK_IMPORTED_MODULE_0__/* .positionNode */ .U_)(node);
      } else {
        if (graph.children(v).length > 0) {
          _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info(
          ...
          _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("OffsetY", offsetY, "labelHeight", labelHeight, "halfPadding", halfPadding);
          await (0,_chunk_VR7AIV22_mjs__WEBPACK_IMPORTED_MODULE_0__/* .insertCluster */ .U)(clusters, node);
          clusterDb.get(node.id).node = node;
        } else {
  ...
  graph.edges().forEach(function(e) {
    const edge = graph.edge(e);
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(edge), edge);
    edge.points.forEach((point) => point.y += subGraphTitleTotalMargin / 2);
    const startNode = graph.node(e.v);
    var endNode = graph.node(e.w);
    const paths = (0,_chunk_VR7AIV22_mjs__WEBPACK_IMPORTED_MODULE_0__/* .insertEdge */ .Jo)(edgePaths, edge, clusterDb, diagramType, startNode, endNode, id);
    (0,_chunk_VR7AIV22_mjs__WEBPACK_IMPORTED_MODULE_0__/* .positionEdgeLabel */ .T_)(edge, paths);
  });
  graph.nodes().forEach(function(v) {
    const n = graph.node(v);
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info(v, n.type, n.diff);
    if (n.isGroup) {
      diff = n.diff;
    }
  });
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("Returning from recursive render XAX", elem, diff);
  return { elem, diff };
}, "recursiveRender");
var render = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(async (data4Layout, svg) => {
  const graph = new dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_7__/* .Graph */ .T({
    multigraph: true,
    compound: true
  }).setGraph({
  ...
  (0,_chunk_VR7AIV22_mjs__WEBPACK_IMPORTED_MODULE_0__/* .markers_default */ .g0)(element, data4Layout.markers, data4Layout.type, data4Layout.diagramId);
  (0,_chunk_VR7AIV22_mjs__WEBPACK_IMPORTED_MODULE_0__/* .clear3 */ .nA)();
  (0,_chunk_VR7AIV22_mjs__WEBPACK_IMPORTED_MODULE_0__/* .clear2 */ .gh)();
  (0,_chunk_VR7AIV22_mjs__WEBPACK_IMPORTED_MODULE_0__/* .clear */ .IU)();
  clear4();
  ...
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("Edges:", data4Layout.edges);
  ...
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("Graph at first:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_6__/* .write */ .M(graph)));
  adjustClustersAndEdges(graph);
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn("Graph after XAX:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_6__/* .write */ .M(graph)));
