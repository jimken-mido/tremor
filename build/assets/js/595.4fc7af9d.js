...
/* harmony export */ });
/* harmony import */ var _chunk_UGV5ZQQN_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8296);
/* harmony import */ var _chunk_YWFND7JV_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(97190);
/* harmony import */ var _chunk_23ATMZXV_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(43620);
/* harmony import */ var _chunk_5N55DQE6_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(27673);
/* harmony import */ var _chunk_2EDTWDYI_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(36553);
/* harmony import */ var _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(64422);
...
var parser = function() {
  var o = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function trace() {
    }, "trace"),
    yy: {},
    ...
    performAction: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 4:
    ...
    parseError: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function parse(input) {
      ...
      (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(popStack, "popStack");
      function lex() {
        var token;
      ...
      (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(lex, "lex");
  ...
  var lexer = /* @__PURE__ */ function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function() {
      ...
      unput: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function() {
      ...
      less: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(match, indexed_rule) {
      ...
      next: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function() {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function popState() {
      ...
      _currentRules: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function _currentRules() {
      ...
      topState: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function topState(n) {
      ...
      pushState: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function pushState(condition) {
        this.begin(condition);
      }, "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"),
      options: {},
      performAction: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
  ...
  (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(Parser, "Parser");
...
var BG_FILL = "bgFill";
var STYLECLASS_SEP = ",";
var config = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .D7)();
var classes = /* @__PURE__ */ new Map();
var sanitizeText = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)((txt) => _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .common_default */ .Y2.sanitizeText(txt, config), "sanitizeText");
var addStyleClass = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(id, styleAttributes = "") {
...
var addStyle2Node = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(id, styles = "") {
  const foundBlock = blockDatabase.get(id);
  if (styles !== void 0 && styles !== null) {
    foundBlock.styles = styles.split(STYLECLASS_SEP);
  }
}, "addStyle2Node");
var setCssClass = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(itemIds, cssClassName) {
...
var populateBlockDatabase = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)((_blockList, parent) => {
...
var clear2 = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(() => {
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug("Clear called");
  (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .clear */ .IU)();
...
function typeStr2Type(typeStr) {
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug("typeStr2Type", typeStr);
  switch (typeStr) {
    case "[]":
      return "square";
    case "()":
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug("we have a round");
      return "round";
    case "(())":
      return "circle";
    case ">]":
...
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(typeStr2Type, "typeStr2Type");
...
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(edgeTypeStr2Type, "edgeTypeStr2Type");
...
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(edgeStrToEdgeData, "edgeStrToEdgeData");
var cnt = 0;
var generateId = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(() => {
  cnt++;
  return "id-" + Math.random().toString(36).substr(2, 12) + "-" + cnt;
}, "generateId");
var setHierarchy = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)((block) => {
  rootBlock.children = block;
  populateBlockDatabase(block, rootBlock);
  blocks = rootBlock.children;
}, "setHierarchy");
var getColumns = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)((blockId) => {
...
var getBlocksFlat = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(() => {
  return [...blockDatabase.values()];
}, "getBlocksFlat");
var getBlocks = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(() => {
  return blocks || [];
}, "getBlocks");
var getEdges = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(() => {
  return edgeList;
}, "getEdges");
var getBlock = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)((id) => {
  return blockDatabase.get(id);
}, "getBlock");
var setBlock = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)((block) => {
  blockDatabase.set(block.id, block);
}, "setBlock");
var getLogger = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(() => console, "getLogger");
var getClasses = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function() {
  return classes;
}, "getClasses");
var db = {
  getConfig: /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(() => (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig */ .zj)().block, "getConfig"),
  typeStr2Type,
  edgeTypeStr2Type,
  edgeStrToEdgeData,
  getLogger,
...
var fade = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)((color, opacity) => {
...
var getStyles = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)((options) => `.label {
...
var padding = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .D7)()?.block?.padding ?? 8;
...
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(calculateBlockPosition, "calculateBlockPosition");
var getMaxChildSize = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)((block) => {
  let maxWidth = 0;
  let maxHeight = 0;
  for (const child of block.children) {
    const { width, height, x, y } = child.size ?? { width: 0, height: 0, x: 0, y: 0 };
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug(
...
function setBlockSizes(block, db2, siblingWidth = 0, siblingHeight = 0) {
  ...
  if (block.children?.length > 0) {
    ...
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug("setBlockSizes abc95 maxWidth of", block.id, ":s children is ", maxWidth, maxHeight);
    for (const child of block.children) {
      if (child.size) {
        _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug(
    ...
    if (width < siblingWidth) {
      ...
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug("Size indata abc88", block.id, "childWidth", childWidth, "maxWidth", maxWidth);
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug("Size indata abc88", block.id, "childHeight", childHeight, "maxHeight", maxHeight);
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug("Size indata abc88 xSize", xSize, "padding", padding);
      for (const child of block.children) {
        if (child.size) {
    ...
    if (width < (block?.size?.width || 0)) {
      ...
      if (num > 0) {
        ...
        _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug("abc95 (growing to fit) width", block.id, width, block.size?.width, childWidth);
        for (const child of block.children) {
          if (child.size) {
            child.size.width = childWidth;
          }
...
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(setBlockSizes, "setBlockSizes");
function layoutBlocks(block, db2) {
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug(
    `abc85 layout blocks (=>layoutBlocks) ${block.id} x: ${block?.size?.x} y: ${block?.size?.y} width: ${block?.size?.width}`
  );
  const columns = block.columns ?? -1;
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug("layoutBlocks columns abc95", block.id, "=>", columns, block);
  if (block.children && // find max width of children
  block.children.length > 0) {
    const width = block?.children[0]?.size?.width ?? 0;
    const widthOfChildren = block.children.length * width + (block.children.length - 1) * padding;
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug("widthOfChildren 88", widthOfChildren, "posX");
    let columnPos = 0;
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug("abc91 block?.size?.x", block.id, block?.size?.x);
    ...
    for (const child of block.children) {
      ...
      if (py != rowPos) {
        ...
        _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug("New row in layout for block", block.id, " and child ", child.id, rowPos);
      }
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug(
      ...
      _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug("abc88 columnsPos", child, columnPos);
    }
  }
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug(
...
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(layoutBlocks, "layoutBlocks");
...
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(findBounds, "findBounds");
function layout(db2) {
  ...
  _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug("getBlocks", JSON.stringify(root, null, 2));
  const { minX, minY, maxX, maxY } = findBounds(root);
  const height = maxY - minY;
  const width = maxX - minX;
  return { x: minX, y: minY, width, height };
}
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(layout, "layout");
...
function getNodeFromBlock(block, db2, positioned = false) {
  ...
  const styles = (0,_chunk_2EDTWDYI_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getStylesFromArray */ .sM)(vertex?.styles ?? []);
  ...
  const node = {
    ...
    intersect: void 0,
    type: vertex.type,
    padding: padding2 ?? (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig */ .zj)()?.block?.padding ?? 0
  };
  return node;
}
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(getNodeFromBlock, "getNodeFromBlock");
async function calculateBlockSize(elem, block, db2) {
  const node = getNodeFromBlock(block, db2, false);
  if (node.type === "group") {
    return;
  }
  const nodeEl = await (0,_chunk_YWFND7JV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .insertNode */ .on)(elem, node);
...
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(calculateBlockSize, "calculateBlockSize");
async function insertBlockPositioned(elem, block, db2) {
  const node = getNodeFromBlock(block, db2, true);
  const obj = db2.getBlock(node.id);
  if (obj.type !== "space") {
    await (0,_chunk_YWFND7JV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .insertNode */ .on)(elem, node);
    block.intersect = node?.intersect;
    (0,_chunk_YWFND7JV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .positionNode */ .U_)(node);
  }
}
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(insertBlockPositioned, "insertBlockPositioned");
...
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(performOperations, "performOperations");
async function calculateBlockSizes(elem, blocks2, db2) {
  await performOperations(elem, blocks2, db2, calculateBlockSize);
}
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(calculateBlockSizes, "calculateBlockSizes");
async function insertBlocks(elem, blocks2, db2) {
  await performOperations(elem, blocks2, db2, insertBlockPositioned);
}
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(insertBlocks, "insertBlocks");
  ...
  for (const edge of edges) {
    if (edge.start && edge.end) {
      ...
      if (startBlock?.size && endBlock?.size) {
        ...
        (0,_chunk_UGV5ZQQN_mjs__WEBPACK_IMPORTED_MODULE_0__/* .insertEdge */ .Jo)(
          elem,
        ...
        if (edge.label) {
          await (0,_chunk_UGV5ZQQN_mjs__WEBPACK_IMPORTED_MODULE_0__/* .insertEdgeLabel */ .jP)(elem, {
            ...edge,
            label: edge.label,
          ...
          (0,_chunk_UGV5ZQQN_mjs__WEBPACK_IMPORTED_MODULE_0__/* .positionEdgeLabel */ .T_)(
...
(0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(insertEdges, "insertEdges");

// src/diagrams/block/blockRenderer.ts
var getClasses2 = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(function(text, diagObj) {
  return diagObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */ (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .K2)(async function(text, id, _version, diagObj) {
  const { securityLevel, block: conf } = (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig */ .zj)();
  ...
  (0,_chunk_UGV5ZQQN_mjs__WEBPACK_IMPORTED_MODULE_0__/* .markers_default */ .g0)(svg, markers, diagObj.type, id);
  ...
  if (bounds) {
    ...
    (0,_chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .configureSvgSize */ .a$)(svg, height, width, !!useMaxWidth);
    _chunk_IIKMQLIC_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .Rm.debug("Here Bounds", bounds, bounds2);
    svg.attr(
      "viewBox",
...
/* harmony export */ });
/* harmony import */ var _chunk_YWFND7JV_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(97190);
